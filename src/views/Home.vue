        ...
        <div class="col-lg-5 intro">
          <div class="intro-card">
            ...
            <div class="bio-paragraph">
              <p>
                I’m a Software Engineer, particularly a frontend developer based
                in Nigeria.
              </p>
              <p>
                I'm usually somewhere on the internet. You can find me
                oversharing on
                <a target="_blank" href="https://twitter.com/black_dev_"
                  >twitter</a
                >, exploring
                <a
                  target="_blank"
                  href="https://www.facebook.com/habib.wahab.16"
                  >facebook</a
                >
                contents, posting exciting projects on
                <a target="_blank" href="https://github.com/iamblackdev"
                  >github</a
                >, or occasionally looking for new stuff to learn.
              </p>
            </div>
            ...
            <div class="socials mt-5 mt-lg-0 mb-5">
              <ul>
                <li class="mx-3">
                  <a
                    href="https://twitter.com/black_dev_"
                    rel="noopener"
                    target="_blank"
                ...
                <li class="mx-3">
                  <a
                    href="https://www.linkedin.com/in/habib-wahab/"
                    rel="noopener"
                    target="_blank"
                    class="flex items-center"
                  >
                ...
                <li class="mx-3">
                  <a
                    href="https://github.com/iamblackdev"
                    rel="noopener"
                    target="_blank"
                    class="flex items-center"
                  >
